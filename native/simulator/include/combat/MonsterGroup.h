...
namespace sts {
    ...
    struct MonsterGroup {
        int monstersAlive = 0;
        int monsterCount = 0;
        // Slime Boss can retain the dead boss and both dead large slimes while
        // exposing four living medium slimes: seven Java MonsterGroup entries.
        std::array<Monster, 7> arr;
