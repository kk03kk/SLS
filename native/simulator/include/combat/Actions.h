...
namespace sts {
    ...
    struct Actions {
        ...
        static Action PlayTopCardRandomTarget(bool exhausts);
        ...
        static Action RetainCardsAction(int count);
