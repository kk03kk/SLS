...
IRONCLAD_A20_ACT1 = CurriculumProfile(
    "IRONCLAD_A20_ACT1", "IRONCLAD", 20, EpisodeHorizon.ACT_1,
    version=1, allow_key_acquisition=True, note_for_yourself_policy="AUTO_LEAVE",
)
IRONCLAD_A20_ACT2 = CurriculumProfile(
    "IRONCLAD_A20_ACT2", "IRONCLAD", 20, EpisodeHorizon.ACT_2,
    version=1, allow_key_acquisition=True, note_for_yourself_policy="AUTO_LEAVE",
)
IRONCLAD_A20_ACT3 = CurriculumProfile(
    "IRONCLAD_A20_ACT3", "IRONCLAD", 20, EpisodeHorizon.ACT_3,
    version=1, allow_key_acquisition=True, note_for_yourself_policy="AUTO_LEAVE",
)
...
IRONCLAD_A20_CURRICULUM = (
    IRONCLAD_A20_ACT1, IRONCLAD_A20_ACT2, IRONCLAD_A20_ACT3, IRONCLAD_A20_HEART,
)
IRONCLAD_CURRICULUM_PROFILES = (
    IRONCLAD_A0_ACT1, IRONCLAD_A20_ACT1, IRONCLAD_A20_ACT2, IRONCLAD_A20_ACT3,
    IRONCLAD_A0_ACT2, IRONCLAD_A0_ACT3,
